...
@click.option("--log-dir", type=click.STRING, default="log-cnnlstm/", help="Directory to log results.")
...
def train_hparams(dataset_path,
    ...
    hparams_space = [
        hp.HParam('num_lstm_units', hp.Discrete([1024, 512, 256])),
    ...
    def create_model(hparams):
        ...
        x = layers.LSTM(hparams["num_lstm_units"], activation="relu")(x)
