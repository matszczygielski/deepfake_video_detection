...
@click.option("--num-lstm-units", type=click.INT, default=256, help="Number of LSTM units in model.")
...
@click.option("--out-model-path", type=click.STRING, default="../models/cnnlstm.h5", help="Path of output model.")
@click.argument("dataset_path", type=click.STRING)
def train(dataset_path,
          in_width, in_height, sequence_len,
          cnn_model, do_freeze_backbone,
          num_lstm_units, num_dense_units,
    ...
    def create_model():
        ...
        x = layers.LSTM(num_lstm_units, activation="relu")(x)
